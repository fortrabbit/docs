...
navigation.excerpt:   Connect your repos
...
You are confident [using Git](/14.tips/git-intro.md). You also have a good understanding of the fortrabbit [deployment options](/6.deployment/1.intro.md). Finally, you have an account here at fortrabbit as well as with GitHub already.

## Installation

To connect GitHub with fortrabbit you need to install the fortrabbit GitHub app with your account at GitHub:

* [fortrabbit GitHub app](https://github.com/apps/fortrabbit)
