...
naviTitle: Intro
excerpt: Git push to deploy and some gotchas
...
4. The build is getting distributed into the web space of the [app environment](/13.objects/2.app-environment.md)
...
In addition to deployment, [direct code access](/7.code-access/1.intro.md) via [SSH](/6.code-access/3.ssh.md) and [SFTP](/6.code-access/4.sftp.md) is also available. This is useful to sync contents and to debug issues.
