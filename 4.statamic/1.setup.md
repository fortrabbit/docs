...
Have a [local development environment](/11.dev-tips/2.local-development.md) with PHP and a web server ready. Also have an app at fortrabbit ready.
...
:DashboardLink{title="Set the root path for 'takas'" path="/environemnts/takas-233/settings/root-path" text="dashboard.com/environments/takas-233/settings/root-path"}
`
