...
At the beginning you have probably been using the App URL as your domain. You can also add any number of domains to your App. Please see our [domain articles](/10.objects/10.domain.md) for more.
...
- [{{app-env-slug}}.frbit.app/cp](https://{{app-env-slug}}.frbit.app/cp)
