...
navigation.excerpt:      A deployment workflow for adventurous developers.
...
1. Set up an SSH key with SSH keygen (no passphrase), see our [SSH keys setup guide](/14.tips/ssh-keys.md)
