...
$ rsync -avR ./content ./users ./resources/blueprints ./resources/fieldsets ./resources/forms ./resources/users ./storage/forms ./public/assets {{app-env-name}}@deploy.{{region}}.frbit.com:~/
```
...
$ rsync -av '{{app-env-name}}@deploy.{{region}}.frbit.com:~/users ./
$ rsync -av '{{app-env-name}}@deploy.{{region}}.frbit.com:~/resources/blueprints ./
$ rsync -av '{{app-env-name}}@deploy.{{region}}.frbit.com:~/resources/fieldsets ./
$ rsync -av '{{app-env-name}}@deploy.{{region}}.frbit.com:~/resources/forms ./
$ rsync -av '{{app-env-name}}@deploy.{{region}}.frbit.com:~/resources/users ./
$ rsync -av '{{app-env-name}}@deploy.{{region}}.frbit.com:~/storage/forms ./ 
$ rsync -av '{{app-env-name}}@deploy.{{region}}.frbit.com:~/public/assets' ./
```
