...
reviewed:      2022-04-10 07:53:48
title:         Backups
excerpt:       Book, download, use
lead:          Working with fortrabbit backups - downloading web storage and MySQL database backups
status:        todo
...
The MySQL backup file is a regular MySQL dump, generated by the `mysqldump` tool. You can recover from it the same way you would (re-)import MySQL data into your database. Please read on [in the MySQL import/export guide](mysql.md#toc-export-amp-import).
