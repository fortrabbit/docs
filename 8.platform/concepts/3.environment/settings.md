...
excerpt:       Dashboard configuration and options
lead:          This is an overview settings available for environments in the dashboard.
status:        todo
...
Good news is: We will inform you by e-mail before it happens and you can start a new trial right away, after your current trial ended. In many cases you can easily re-deploy your code base to the new App: When deploying with [Git](2.git-deployment.md), you just change the remote and push again. When using our CMS/framework presets with predefined [ENV vars](env-vars.md) database access will work without code modification.
