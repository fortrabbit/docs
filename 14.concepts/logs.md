...
## Live log access from the command line
...
You can also access your log files, including older logs via [SSH](../.20.platform/2.objects/3.environment/ssh-uni) or [SFTP](../.20.platform/2.objects/3.environment/sftp-uni). They are usually stored in the folder `logs`, right above the `htdocs` folder. The `log` folder contains up to eight files, by type of log and time:
...
* [Craft CMS logging](/craft-tune#logging)
* [Laravel logging](/install-laravel#logging)
