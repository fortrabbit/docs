...
When you have chosen Craft CMS in the [software preset](/11.concepts/software-presets.md) while creating the app environment, the following two commands are part of your [deployment build steps](/6.deployment/3.build-commands.md).
