...
An account on fortrabbit represents a person, not an entity. Your account settings are part of your [personal access](/10.objects/3.person.md) to the fortrabbit system. You can choose your type of account when signing up and change it later on if you made mistake initially.
