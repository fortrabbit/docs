...
Using our [Git deployment](2.git-deployment.md) is great, but sometimes need a little more control. That's where the Secure SHell comes in. SSH is the big brother of [SFTP](sftp) and allows you to directly interact with your App's code. You may want to set up an [SSH Key](14.ssh-keys.md) if you don't have one already.
...
Please follow the instructions on the [SSH Keys](14.ssh-keys.md) page.
