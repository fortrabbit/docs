...
excerpt:       About the oldschool code access method
status:        todo
...
It is also possible to [deploy with Git](2.git-deployment.md) here and also use [SSH](/ssh-uni). It is not recommended to mix the different deployment methods. Please see our [deployment methods article](deployment-methods-uni) to learn how the different ways to deploy code work side by side.
