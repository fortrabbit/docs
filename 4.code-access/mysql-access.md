...
title:         MySQL access
naviTitle:     Access
excerpt:       Connect from local and app / environment
...
If possible, we recommend to use [MySQL env vars](env-vars.md) instead of hard coding them into your configuration files. The automatically available environment variables are:
