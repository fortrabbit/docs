...
title:         SSH key setup
excerpt:       How to set up SSH keys on your local machine
...
Use SSH keys to authenticate with fortrabbit services, including **[deploying via Git](3.guides/1.craft/more/git.md)**, [accessing live logs](logging-pro) and [remote MySQL access](mysql.md#toc-remote-mysql-access). SSH key authentication is more secure and arguably more convenient.
...
To import the public part into your fortrabbit Account via Dashboard, read about [importing keys](14.ssh-keys.md#toc-import-a-public-keys-into-your-fortrabbit-account) further down.
