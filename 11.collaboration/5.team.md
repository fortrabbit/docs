...
Deleting a Comoany will not cancel your Account, [see dedicated instructions for that](/account#deleting-an-account). When a Company has more than one Owner, you can also just leave it:
...
You can also change the ownership of Apps at any time. It starts with the App, find [more details on App ownership changing over there](/app#changing-app-ownership).
