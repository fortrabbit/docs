...
reviewer: fl
title: Laravel Valet
description: 'Laravel Valet is a macOS local development environment for Laravel and other PHP frameworks, bundling NGINX and DnsMasq behind one command.'
navigation.excerpt: Websites running on your local host
lead: A macOS local development environment for Laravel and other PHP frameworks.
figure:
  emoji: 👨‍✈️
  text: Valet at your service.
  color: rgb(100, 90, 120)
  textColor: rgb(12, 12, 15)
head:
  meta:
    - name: 'keywords'
      content: 'laravel valet, local development, macOS, localhost, vhosts, fortrabbit'
topics:
  - local-development
  - laravel
---
