...
- **DDEV** (recommended): [See guide](/4.integrations/01.local-development/03.ddev.md)
...
- **Laravel Valet**: [See guide](/4.integrations/01.local-development/02.laravel-valet.md)
