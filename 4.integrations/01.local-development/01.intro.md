...
description: 'A local PHP development environment keeps testing, debugging and experiments off production, and keeps a project independent of its host.'
naviTitle: Intro
...
figure:
  ...
  color: rgb(2, 209, 255)
  textColor: rgb(0, 92, 113)
head:
  meta:
    - name: 'keywords'
      content: 'fortrabbit, local development, PHP, LAMP, docker, application lifetime management'
topics:
  - local-development
---
...
- **Laravel Sail**: [See guide](/4.integrations/01.local-development/05.laravel-sail.md)
...
**Classical GUIs** These solution stacks are easy to handle through a graphical interface and they interfere with the rest of your system as little as possible. The most commonly used here are [MAMP](https://www.mamp.info) (free and paid version) and [XAMPP](https://www.apachefriends.org/index.html). [Laragon](https://laragon.org/) is a fast, open source option for Windows. Please mind that those don't include Git and Composer.
