...
**Classical GUIs** These solution stacks are easy to handle through a graphical interface and they interfere with the rest of your system as little as possible. The most commonly used here are [MAMP](https://www.mamp.info) (free and paid version) and [XAAMP](https://www.apachefriends.org/index.html). [Laragon](https://laragon.org/) is a fast, open source option for Windows. Please mind that those don't include Git and Composer.
