...
reviewer: fl
title: Datadog
description: 'Datadog monitors servers, databases and services, but it requires the Datadog Agent on the host, which a shared fortrabbit environment cannot run.'
