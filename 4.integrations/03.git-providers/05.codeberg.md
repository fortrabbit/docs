...
reviewer: fl
title: Codeberg
description: 'Codeberg has no native fortrabbit app. Deploy from it with Codeberg CI (Woodpecker), pushing to the fortrabbit git remote from the pipeline.'
...
lead: Integrate Codeberg with fortrabbit using Woodpecker CI.
draft: true
topics:
  - git
  - deployment
