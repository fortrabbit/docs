...
The [MCP server](/1.platform/04.automation/03.mcp.md) registers into the user profile with one command, and [GitHub Copilot](/4.integrations/17.ai-coding/03.github-copilot.md) agent mode picks the tools up from there — apps, environments, deployment logs, and creating an app or an environment:
