...
ai: co-authored
title: VS Code
description: 'Use VS Code with fortrabbit: the extension ecosystem, remote editing over SSH and SFTP, and the PHP tooling worth installing first.'
naviTitle: VS Code
...
The [MCP server](/1.platform/04.automation/02.mcp.md) registers into the user profile with one command, and [GitHub Copilot](/4.integrations/17.ai-coding/03.github-copilot.md) agent mode picks the tools up from there — apps, environments, deployment logs, and creating an app or an environment:
