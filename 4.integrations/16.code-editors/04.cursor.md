...
The [MCP server](/1.platform/04.automation/03.mcp.md) connects Cursor's agent to apps, environments and deployments. There is a one-click install link, or the entry can be pasted into `~/.cursor/mcp.json`:
