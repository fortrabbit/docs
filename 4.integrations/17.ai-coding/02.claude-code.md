...
lead: Claude Code is Anthropic's official TUI for Claude. It runs in your terminal and can read your codebase, edit files, run commands, and carry out multi-step tasks from a single prompt.
head:
  meta:
    - name: 'keywords'
      content: 'Claude Code, Anthropic, Claude, AI coding, terminal agent, CLI'
---
...
Claude Code is primarily a terminal tool, but it integrates with [VS Code](/4.integrations/16.code-editors/02.vscode.md) and [JetBrains PhpStorm](/4.integrations/16.code-editors/03.phpstorm.md) as an extension. In the editor it shows diffs, highlights modified files, and lets you accept or reject changes in a dedicated panel. The core interaction still happens through a CLI prompt or the extension's chat interface.
