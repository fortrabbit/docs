...
**[CLI](/1.platform/04.automation/02.cli.md) and [public API](/1.platform/04.automation/01.api.md)** — the fallback for anything the tool set does not expose. An assistant that can run shell commands can run `frbit`, and the API covers the rest.
