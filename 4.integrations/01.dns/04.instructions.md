...
You should have a domain created with the fortrabbit dashboard. See the [domain setup guide](/1.platform/13.dns/2.external-domain-setup.md). You should also have a domain registered somewhere. See [domain provider intro](/4.integrations/01.dns/01.intro.md).
...
Also See [integration instructions](/4.integrations/01.dns/03.cloudflare.md).
