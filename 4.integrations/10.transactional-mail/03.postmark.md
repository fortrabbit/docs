...
reviewer: fl
title: Postmark
description: 'Configure Postmark for transactional email from a fortrabbit app, including the DKIM and DNS records that keep messages out of spam folders.'
...
sidebar: postmark
lead: Configure Postmark for transactional email delivery on fortrabbit with DKIM and DNS records.
head:
  meta:
    - name: keywords
      content: postmark, transactional email, email delivery, fortrabbit, DKIM, DNS
topics:
  - email
---
