...
description: 'MySQL Workbench is the official MySQL GUI. Connect it to a fortrabbit database over an SSH tunnel for modeling, queries and administration.'
...
head:
  meta:
    - name: 'keywords'
      content: 'mysql workbench, database client, ssh tunnel, fortrabbit, gui, remote'
topics:
  - mysql
---
