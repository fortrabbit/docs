...
reviewer: fl
title: TablePro
description: 'TablePro is a native macOS client for MySQL, PostgreSQL and 15 more engines. Connect to a fortrabbit database over SSH, with optional AI help.'
ai: co-authored
...
head:
  meta:
    - name: 'keywords'
      content: 'tablepro, database client, mysql, postgresql, macos, fortrabbit'
topics:
  - mysql
---
