...
reviewed:    2023-07-12 13:03:27
title:       Craft CMS assets handling
naviTitle:   Assets handling
lead:        Learn how to deploy Craft CMS runtime data using rsync or SFTP.
excerpt:     Syncing uploads up and down
status:      todo

link:
  route: https://craftcms.com/
  text:  craftcms.com
...
For best results here, make sure you have completed all steps from the [get ready guide](/craft-start). Further, this guide is for advanced users already using [Git deployment to deploy Craft](/craft-deploy-git). You don't need to care about all this, when you have [uploaded Craft with SFTP](/craft-upload-sftp).
