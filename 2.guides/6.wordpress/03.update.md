...
1. For the **database**, check our [MySQL article for import/export](/3.dev/08.mysql/02.export-import/07.export-import-intro.md).
2. For the **files** you can either use [SFTP](/3.dev/01.code-access/4.sftp.md) or have a look at [rsync](//3.dev/20.how-to/rsync.md) to synchronize certain folders.
