...
WordPress consists of code files, the user generated uploads and of course the [MySQL database](/1.platform/9.components/2.mysql.md), in which most of the contents are stored. There are various use cases to export and import the database:
