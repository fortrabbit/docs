...
Our recommendation is to use a [combination of Git and rsync](/2.guides/4.kirby/2.git-and-rsync.md) where code is deployed via Git and the content folder is synced down (and up) by rsync. But you can also deploy the whole project using rsync as well. Upload code changes and download content changes.
...
See the [rsync article](/3.dev/rsync.md) for more details.
