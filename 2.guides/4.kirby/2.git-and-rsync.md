...
Make sure to read the [Kirby Composer guide](https://getkirby.com/docs/guide/install-guide/composer) from the official Kirby docs. You should have a [local development environment](/3.dev/1.local-development.md) including PHP and Composer running.
