...
Kirby CMS offers different starting points for new projects. Adjust to your needs:
...
- [Composerkit](https://github.com/getkirby/composerkit): best git/composer support. Adjust [root path](/1.platform/06.settings/12.root-path.md) to `public`.
