...
lead: This is yje recommended workflow to deploy Kirby using Git. It's a bit more advanced, but worth the mile when maintaining a project.
sidebar: kirby
---
...
- Have a [local development environment](/3.dev/20.how-to/1.local-development.md) including PHP and Composer running.
...
$ rsync -av ./content {{app-env-id}}@ssh.{{region}}.frbit.app:/data/www
```
...
$ rsync -av {{app-env-id}}@ssh.{{region}}.frbit.app:/data/www/content/ ./content/
```
