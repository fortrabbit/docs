...
See the [git guides](/1.platform/05.deployment/01.intro.md) on how to connect a local repo to the GitHub remote and enable automatic deployment by installing the fortrabbit App with GitHub account.
