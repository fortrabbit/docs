...
It is recommended to have a [local development environment](/3.dev/19.how-to/1.local-development.md). Here is a quick guide on how quickly get the Kirby plainkit running locally without Git from your terminal:
