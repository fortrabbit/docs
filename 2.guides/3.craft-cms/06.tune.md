...
DevMode is disabled by default via [software template](/1.platform/03.concepts/05.software-templates.md) on fortrabbit as the installation is public. You can change that setting with by [ENV vars](/1.platform/06.settings/01.env-vars.md) in the fortrabbit dashboard:
