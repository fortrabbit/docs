...
The [software templates](/11.concepts/software-templates.md) will populate required ENV vars. If you didn't choose the Craft preset when creating the app or the ENV vars have been deleted, this is likely what needs to be set.
