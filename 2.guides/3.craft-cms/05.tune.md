...
See our [quirks article](/1.platform/03.concepts/09.limits.md) on limits sending emails. Also see [transactional mail provider integration](/1.platform/15.integrations/02.transactional-mail/01.intro.md).
