...
When you have chosen Craft CMS in the [software preset](/1.platform/11.concepts/software-templates.md) while creating the app environment, the following two commands are part of your [deployment build steps](/3.dev/2.deployment/3.build-commands.md).
