...
Run long running processes in a isolated environment without hurting site delivery. The [jobs component](/1.platform/09.components/007.jobs.md) allows you to create a [worker job](/1.platform/30.jobs/03.workers.md) to run in the background.
