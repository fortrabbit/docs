...
When you have chosen Craft CMS in the [software preset](/1.platform/02.concepts/05.software-templates.md) while creating the environment, the following two commands are part of your [deployment build steps](/3.dev/03.deployment/3.build-commands.md).
