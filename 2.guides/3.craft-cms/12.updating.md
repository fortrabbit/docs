...
Your [local development environment](/3.dev/20.how-to/1.local-development.md) is where changes are applied and tested first. Please update your local Craft CMS installation first and apply updates by deploying as a second step. That way you make sure that your environments are in sync.
