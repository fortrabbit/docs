...
In case you haven't already, set up Git, configure a Git repo as a remote and push the code. See our [deployment intro article](/6.deployment/1.intro.md) for more details on Git here on fortrabbit.
