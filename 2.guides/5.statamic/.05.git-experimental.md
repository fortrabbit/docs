---
reviewed: 2026-02-03 14:40:36
title: Statamic Git experimental deployment workflow
description: 'An experimental Statamic workflow using Git Automation to write content back into the repository. For adventurous developers only.'
naviTitle: Experimental deployment
...
2. Follow our [GitHub guides](/1.platform/06.deployment/02.github-app.md) to connect to GitHub and enable automatic deployment
...
1. Set up an SSH key with SSH keygen (no passphrase), see our [SSH keys setup guide](/3.dev/15.learn/01.ssh-key-setup.md)
...
See the [Statamic Git guide](https://statamic.dev/git-automation#remote-setup) and the [fortrabbit git guide](/1.platform/06.deployment/01.intro.md) as reference.
