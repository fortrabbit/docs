...
To enable git deployments, init git and add GitHub as remote repo - either as a public or private.
...
In case you haven't already, set up Git, configure a Git repo as a remote and push the code. See our [deployment intro article](/1.platform/05.deployment/01.intro.md) for more details on Git here on fortrabbit.
