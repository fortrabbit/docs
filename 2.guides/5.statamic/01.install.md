...
## Install Statamic on the environment

Another option is to install Statamic directly on the server like so:
...
We believe it's easier and more straight forward to start with a local development environment first.
