...
2. Follow our [GitHub guides](/1.platform/05.deployment/02.github-app.md) to connect to GitHub and enable automatic deployment
...
See the [Statamic Git guide](https://statamic.dev/git-automation#remote-setup) and the [fortrabbit git guide](/1.platform/05.deployment/01.intro.md) as reference.
