...
2. Follow our [GitHub guides](/1.platform/05.deployment/2.github-app.md) to connect to GitHub and enable automatic deployment
...
1. Set up an SSH key with SSH keygen (no passphrase), see our [SSH keys setup guide](/3.dev/15.learn/01.ssh-keys.md)
