...
2. Follow our [GitHub guides](/3.dev/2.deployment/2.github-app.md) to connect to GitHub and enable automatic deployment
...
See the [Statamic Git guide](https://statamic.dev/git-automation#remote-setup) and the [fortrabbit git guide](/3.dev/2.deployment/1.intro.md) as reference.
