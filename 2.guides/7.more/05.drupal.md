...
Drupal supports Git and Composer workflows. Deploy via GitHub using our [GitHub integration](/1.platform/05.deployment/02.github-app.md) via `git push`. SSH/SFTP code access is also available.
