...
When the upload is finished, visit [\{\{app-env-id\}\}.frbit.app](https://{{app-env-id}}.frbit.app)
in your browser and commence with the guided web installation to finish the setup.
