...
2. Copy all **contents** of the local `grav-admin` folder (not the folder itself) via [SFTP](/3.dev/7.code-access/4.sftp.md) to the `htdocs` folder of your app environment.
