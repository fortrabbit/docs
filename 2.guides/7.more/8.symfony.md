...
If you did not choose Symfony when creating the environment in the dashboard at first, please set the following: Go to the dashboard and set the [root path](/1.platform/10.objects/environment/12.root-path.md) to 'public'.
