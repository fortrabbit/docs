...
Once doctrine is configured and the changes are deployed, you may want to run migrations and maybe load fixtures. You can login via [ssh](/1.platform/04.code-access/03.ssh.md) in to your environment, or instead just fire single commands like so:
