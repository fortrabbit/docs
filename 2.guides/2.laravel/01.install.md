...
In some cases Laravel is the framework for the actual software that runs on top - like with [Statamic](/2.guides/5.statamic/01.install.md) or [October CMS](/2.guides/7.more/6.october-cms.md).
