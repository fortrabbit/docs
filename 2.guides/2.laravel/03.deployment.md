...
But Laravel is versatile. It can act as a backend to exchange with a frontend or it can be used as a monolith. It might be extended with additional software. Therefore [deployment build step pipeline](/1.platform/05.deployment/3.build-commands.md) options differ.
