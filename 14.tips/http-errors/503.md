...
503 and [504 errors](/14.tips/http-errors/504.md) are two sides of the same coin. PHP-FPM (the PHP process manager here) has too much to do. 503 and 504 errors are often happening simultaneously.
...
Review your code and configuration changes. Compare this with your [local development environment](/14.tips/local-development.md) and see if it fails the same way. Have you ran an update recently?
