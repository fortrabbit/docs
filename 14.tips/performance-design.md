...
You can always throw more hardware on [performance problems](/14.tips/performance-problems.md). But that won't always help when the problem is in the code somewhere. We want you to encourage to **design for performance** and scalability. And that is all about thinking a bit ahead.

## Backend performance design

This is the part where fortrabbit is involved the most. The TTFB depends on how fast the service can compute. Your code plays a major role. Also see the [PHP processes article](/14.tips/php-processes.md) to learn about limits when executing PHP. See our [performance problems article](/14.tips/performance-problems.md) on how to analyze backed performance problems.
...
Enable our [WAF feature](/11.concepts/incoming-firewall.md).
