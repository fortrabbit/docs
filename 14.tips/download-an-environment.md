...
After cloning the Git repo, you might need to install the dependencies to make your local installation complete. The `composer.json` contains all the instructions. Run `composer install` locally in your root folder. See our [Composer article](/14.tips/composer.md) for more details.
...
- Use rsync to download a folder or even the entire project - [see here](/14.tips/rsync.md)
