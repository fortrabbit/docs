...
Once you've added a [custom domain](/10.objects/10.domain.md) you may want to prevent requests to your environment URL. The example below shows how to set up a domain based redirect in your `.htaccess` file.
