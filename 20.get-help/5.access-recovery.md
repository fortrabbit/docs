...
When you know the e-mail that has been used for the account here and you have access to it proceed by resetting the Account password. This way you regain access and set a new password so that only you can login. That will not work when the Account has 2FA enabled, please see above.
