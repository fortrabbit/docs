...
reviewed:  2023-09-26 08:45:40
title:     Website down!
navigation.excerpt:   What to do when something is offline
lead:      "Your website hosted here is offline right now? Let's waste no time and get it solved together in a professional manner. This article helps finding common issues when your website is down and also how to communicate effectivly."
...
It's likely a 504 error when the website is loading and loading but never shows up or show up a 504 error page. Please proceed to our [504 troubleshooting](/14.tips/http-errors/504.md) page.

It's likely a 503 error when you see a "service unavailable" message or just a blank screen or a 503 error page. Please proceed to our [503 troubleshooting](/14.tips/http-errors/503.md) page. Provide PHP error logs with your question.
...
Also see our [general support tips](/20.get-help/4.zen-support.md) on best practices to make your support request here successful.
