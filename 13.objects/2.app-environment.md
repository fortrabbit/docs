...
While the Git repo is connected with the [app](/13.objects/1.app.md), the app environment can be mapped to a git branch. [Git deployment](/6.deployment/1.intro.md) is optional but blends in nicely.

- An environment is a sub object of an [app](/13.objects/1.app.md)
- Each app needs to have at least one environment
- Environments are managed in the [dashboard](/14.concepts/dashboard.md)
- Each environment is a separated hosting setup
- Each environment has individual settings
- Each environment has individually billed [components](/14.concepts/components.md)
- Create [multi staging workflows](/12.dev-tips/multi-staging.md) with multiple app environments
