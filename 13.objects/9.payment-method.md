...
- Each app - except [during trial](/14.concepts/2.free-trial.md) - is owned by a payment method
- Payment methods can own multiple [apps](/13.objects/1.app.md)
- Payment methods are managed by people directly or in [teams](/13.objects/4.team.md)
...
You may be collaborating with other, in a team or in a client relation. Payment methods can also be shared. You can [invite someone to collaborate or to take over a payment method](/18.tips/inviting-a-client.md).
...
Deleting a payment method is similar to a [service cancellation](/14.concepts/service-cancellation.md), since all the apps owned will be deleted as well and the invoice archive will be removed.
