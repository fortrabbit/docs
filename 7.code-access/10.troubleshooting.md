...
- Have you been able to [access code](/7.code-access/1.intro.md) before?
- Is the same key you are using now here working elsewhere?

See our [SSH key setup](/14.tips/ssh-keys.md) article if you are unsure about your SSH keys.
...
```shell
$ ssh {{app-env-slug}}@deploy.{{region}}.frbit.com -v
