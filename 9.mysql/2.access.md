...
If possible, we recommend to use [MySQL env vars](/14.concepts/env-vars.md) instead of hard coding them into your configuration files. The automatically available environment variables are:
