...
To keep deployment fast for everyone the size of the release package is limited to 200 MB. [Read on](platform/concepts/3.environment/git.md#toc-release-package-limit).
