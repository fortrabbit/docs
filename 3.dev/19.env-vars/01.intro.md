...
- **Security**: Store sensitive information like database credentials and API keys outside of your codebase. See [ENV var security](/3.dev/19.env-vars/1.intro.md/20.security.md).
