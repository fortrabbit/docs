...
Modern PHP frameworks like [Laravel](/2.guides/2.laravel/01.install.md) and [Symfony](/2.guides/7.more/8.symfony.md) …) and some CMS like [Craft CMS](/2.guides/3.craft-cms/01.setup.md) use `.env` files for configuration and include a parser already.
