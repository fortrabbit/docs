...
Most websites performance problems can be backtraced to code and config issues. Most often it's oversight or missing experience and attention to [performance design](/3.dev/10.performance/04.best-practices.md) from the developer.
