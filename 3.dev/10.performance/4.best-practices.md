...
This is the part where fortrabbit is involved the most. The TTFB depends on how fast the service can compute. Your code plays a major role. Also see the [PHP processes article](/3.dev/10.performance/6.reference.md) to learn about limits when executing PHP. See our [understand performance article](/3.dev/10.performance/1.intro.md) on how to analyze backed performance problems.
