...
- Redis: Modern key value im memory caching service, see the [Redis component article](/1.platform/9.components/8.redis.md)
...
Our [traffic tiers](/1.platform/9.components/4.traffic.md) are not designed to host local videos. It's recommended to outsource video hosting to a 3rd party. That will also help with compression and delivery.
