...
- See the direct [code access intro](/3.dev/01.code-access/1.intro.md) for uses cases and limits.

## Accessing SSH

Each [app environment](/1.platform/10.objects/02.app-environment.md) has it's own SSH access. Execute the following in your terminal to login:
