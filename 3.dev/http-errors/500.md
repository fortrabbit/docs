...
Since 500 errors often appear during installation, setup or code changes: Review your code and configuration changes. Compare this with your [local development environment](/3.dev/1.local-development.md) and see if it fails the same way. Have you ran an update recently?
