...
Examine the logs of your App. See [here](/1.platform/10.objects/environment/23.logs.md). There you'll likely find where the application exited with which error.
