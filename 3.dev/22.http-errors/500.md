...
Our experience in support shows us that many 500 errors are caused by wrong rules in your `.htaccess` file. See our [main article on `.htaccess`](/3.dev/21.htaccess/1.intro.md) for some background. Have you made any changes to `.htaccess` lately?
