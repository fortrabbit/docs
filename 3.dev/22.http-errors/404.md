...
Creating an app environment can sometimes take a few minutes. If you visit the test URL during that time, you'll get a 404 error. It's possible that this DNS response gets cached locally. The same is true for new domains.
