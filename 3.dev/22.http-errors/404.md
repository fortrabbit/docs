...
figure:
  emoji: ❓
  text: What if when file not found.
  color: rgba(220, 140, 140, 1)
  textColor: rgba(200, 10, 10, 1)
lead: 'The 404 HTTP status code means "File Not Found" and is super common. The server can be reached and is answering but there is nothing to show under this address. This article aims to help developers troubleshooting 404 errors.'
---
