---
reviewed: 2024-02-10 11:59:53
title: 504 errors
navigation.excerpt: Gateway timeout
figure:
  emoji: ❗
  text: Solve gateway timeout issues.
...
Review your code for inefficient queries. If unsure consult a senior colleague or use a profiler like [Blackfire](/1.platform/15.integrations/04.apm/02.blackfire.md) to find the bottlenecks. Refactor your query design to write better performing MySQL queries or even rethink your data model. Caching certain database results can be another tactic after refactoring.
