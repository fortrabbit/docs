---
reviewed: 2025-11-12 12:14:10
title: 400 errors
navigation.excerpt: Bad request
figure:
  emoji: ❗
  text: Fix malformed request errors.
  color: rgba(220, 140, 140, 1)
  textColor: rgba(200, 10, 10, 1)
lead: 'A 400 HTTP status code means "Bad Request". The server was reached but rejected the request before it reached your application logic. Understand and fix 400 responses on fortrabbit.'
---
