...
Examine the logs of your environment. See [here](/1.platform/06.settings/25.logs.md). There you'll likely find where the application exited with which error. Compare this with your local development environment and see if it fails the same way. Review your latest code changes.
