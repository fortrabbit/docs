...
You are confident [using Git](/3.dev/git-intro.md). You also have a good understanding of the fortrabbit [deployment options](/6.deployment/1.intro.md). Finally, you have an account here at fortrabbit as well as with GitHub already.
