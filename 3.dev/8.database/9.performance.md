...
Many [504 errors](/3.dev/http-errors/2.504.md) and slow PHP response times are related to slow MySQL queries. It's your job as the responsible developer to make sure no insane MySQL queries are executed with your [app environment](/1.platform/10.objects/2.app-environment.md). When using a framework or CMS you might not write MySQL queries directly. Still you need to take that the requests to the database are executed without waste.
...
- New Relic - [see integration guide](/14.integrations/new-relic.md)
- Blackfire - [see integration guide](/14.integrations/blackfire.md)
