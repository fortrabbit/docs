...
You have followed the [deployment section](/3.dev/03.deployment/index.md) so far and are ready to deploy code via git using the GitHub integration.
...
Post deploy commands are configured in the fortrabbit dashboard for each [app environment](/1.platform/10.objects/02.app-environment.md). You can access these settings through the deployment configuration:
