...
Post deploy commands are configured in the fortrabbit dashboard for each [environment](/1.platform/10.objects/environment/01.intro.md). You can access these settings through the deployment configuration:
