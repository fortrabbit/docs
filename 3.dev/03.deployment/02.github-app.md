...
You are confident [using Git](/3.dev/15.learn/git-intro.md). You also have a good understanding of the fortrabbit [deployment options](/3.dev/2.deployment/1.intro.md). Finally, you have an account here at fortrabbit as well as with GitHub already.
