...
You are confident [using Git](/3.dev/15.learn/git-intro.md). You also have a good understanding of the fortrabbit [deployment options](/3.dev/03.deployment/01.intro.md). Finally, you have an account here at fortrabbit as well as with GitHub already.
...
The Git branch maps to the [app environment](/1.platform/10.objects/02.app-environment.md) at fortrabbit. You can create app environments for your branches.
