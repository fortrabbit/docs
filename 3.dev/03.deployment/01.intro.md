...
In addition to git deployment, [direct code access](/3.dev/7.code-access/1.intro.md) via [SSH](/3.dev/7.code-access/3.ssh.md) and [SFTP](/3.dev/01.code-access/4.sftp.md) is also available. This is useful to sync down contents.
