...
4. The build is getting distributed into the web space of the [app environment](/1.platform/10.objects/02.app-environment.md)
...
In addition to git deployment, [direct code access](/3.dev/01.code-access/1.intro.md) via [SSH](/3.dev/01.code-access/3.ssh.md) and [SFTP](/3.dev/01.code-access/4.sftp.md) is also available. This is useful to sync down contents.
...
3. Changes done by [direct code access](/3.dev/01.code-access/1.intro.md)
