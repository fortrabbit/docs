...
[Domains](/1.platform/10.objects/10.domain.md) registered with the [dashboard](/1.platform/11.concepts/dashboard.md) have a target setting. You can choose to route the domain directly to the root path of an environment or to be forwarded.
