...
- [Database upload via terminal](/3.dev/08.mysql/02.export-import/08.database-up-terminal.md)
- [Database download via terminal](/3.dev/08.mysql/02.export-import/09.database-down-terminal.md)
