...
Make sure to be able to access the remote fortrabbit database from your local development environment. See the [database access article](/3.dev/08.mysql/01.db-access-local-intro.md).
...
1. Open your MySQL GUI
2. Create a new connection as [shown in the access guide](/3.dev/08.mysql/01.db-access-local-intro.md#toc-mysql-workbench)
