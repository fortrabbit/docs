...
For security and practical reasons we consider it bad practice to install phpMyAdmin on fortrabbit. However, you can also manage the remote MySQL with a local phpMyAdmin installation. Add an additional server configuration to your local phpMyAdmin `config.inc.php` file like so:
