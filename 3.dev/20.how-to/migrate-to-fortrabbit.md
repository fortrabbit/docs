...
If your App is using a MySQL database, you will need to migrate the database data as well. [Export the MySQL database from your old hosting and import](/3.dev/08.mysql/02.export-import/07.export-import-intro.md) it to the fortrabbit database.

## 6. Sending e-mails

Take care when you application needs to send mails. Simple `sendmail` won't work, see our [quirks article](/1.platform/02.concepts/04.limits.md#mailing) on how to send mails, either via SMTP or 3rd party provider.
