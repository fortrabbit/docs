...
We recommend to have a local development environment, also see our [help article on that](/3.dev/20.how-to/1.local-development.md). First, make sure that your local PHP version is up-to-date. Depending on how your local development is set up, the path to upgrade is different.
