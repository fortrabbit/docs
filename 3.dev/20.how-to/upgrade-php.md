...
Now, quickly after the new PHP version is in place, deploy your updated code from your local development, either with [Git](//3.dev/2.deployment/1.intro.md or simply by [SFTP](/3.dev/01.code-access/4.sftp.md) or by [rsync](//3.dev/20.how-to/rsync.md).
