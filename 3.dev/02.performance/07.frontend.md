...
description: 'Frontend performance on the last mile: asset builds, caching headers, image formats and the load time visitors actually feel.'
...
You can hook in Node.js pipelining tasks during [deployment build steps](/1.platform/06.deployment/03.build-commands.md).
