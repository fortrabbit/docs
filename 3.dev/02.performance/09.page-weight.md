...
reviewer: fl
ai: co-authored
title: Keeping page weight in check
description: 'Page weight drives traffic cost, load time and search ranking at once. How to send fewer bytes without redesigning the site.'
naviTitle: Page weight
navigation.excerpt: Send fewer bytes over the wire, cut traffic, load faster, rank better and use fewer resources.
figure:
  emoji: ⚖️
  text: Avoid website obesity.
  color: rgb(170, 190, 190)
  textColor: rgb(60, 80, 80)
lead: Send fewer bytes over the wire. It will cut traffic, load faster, rank better and use fewer resources. Most pages are too fat.
nextNav: true
head:
  meta:
    - name: keywords
...
1. [Traffic](/1.platform/09.components/04.traffic.md)
2. Load time
3. Search engines ranking
...
In his 2015 talk [The Website Obesity Crisis](https://idlewords.com/talks/website_obesity.htm), Maciej Ceglowski set a memorably strict yardstick for text-heavy pages:

:ContentQuote{text="Text-based websites should not exceed in size the major works of Russian literature."}
...
- [Squoosh](https://squoosh.app) — browser based, runs locally, compares formats side by side. Best for one-offs.
- [sharp](https://sharp.pixelplumbing.com) — the Node workhorse for build pipelines. WebP, AVIF and MozJPEG.
- [pngquant](https://pngquant.org) and [oxipng](https://github.com/oxipng/oxipng) — the PNG pair, lossy pass first, lossless after.
