...
description: 'The usual causes of a slow app: development settings left on in production, missing caching, grown data volumes and traffic changes.'
...
- All assets are re-generated with each deployment or even page load — see [cached directories](/1.platform/06.deployment/07.cached-directories.md) to preserve vendor folders across deploys
