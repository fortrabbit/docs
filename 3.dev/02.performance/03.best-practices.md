---
reviewed: 2025-01-20 20:59:25
title: PHP performance best practices
naviTitle: PHP performance
...
We want you to encourage to **design for performance** and scalability. And that is all about thinking a bit ahead. Speed matters for your users and for SEO. You the PHP developer may have more responsibility than you think.

## Backend performance design

This is the part where fortrabbit is involved the most. The TTFB depends on how fast the service can compute. Your code plays a major role. Also see the [PHP processes article](/3.dev/02.performance/09.reference.md) to learn about limits when executing PHP. See our [understand performance article](/3.dev/02.performance/01.intro.md) on how to analyze backed performance problems.
...
- Redis: Modern key value im memory caching service, see the [Redis component article](/1.platform/09.components/8.redis.md)
...
Our [traffic tiers](/1.platform/09.components/4.traffic.md) are not designed to host local videos. It's recommended to outsource video hosting to a 3rd party. That will also help with compression and delivery.
