...
SSH key authentication is used to securely identify you for [code access](/3.dev/01.code-access/1.intro.md). Remember, on fortrabbit an account represents a [person](/1.platform/10.objects/3.person.md). Your fortrabbit account may store the public parts of several SSH keys.

## Reuse your GitHub SSH keys

Already using GitHub and our [deployment flows](/3.dev/03.deployment/01.intro.md)? The fortrabbit dashboard can directly import public keys associated with your GitHub account so you don't need to setup additional keys for this.
