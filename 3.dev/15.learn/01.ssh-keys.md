...
SSH key authentication is used to securely identify you for [code access](/1.platform/04.code-access/01.intro.md). Remember, on fortrabbit an account represents a [person](/1.platform/10.objects/03.person.md). Your fortrabbit account may store the public parts of several SSH keys.
