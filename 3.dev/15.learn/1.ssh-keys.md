...
Already using GitHub and our [deployment flows](/3.dev/2.deployment/1.intro.md)? The fortrabbit dashboard can directly import public keys associated with your GitHub account so you don't need to setup additional keys for this.
