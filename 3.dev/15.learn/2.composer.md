...
It's recommended that you have a [local development environment](/3.dev/1.local-development.md) running including Composer and that you are making use of it already. Have a good understanding of [deployment in general](/6.deployment/1.intro.md) and on fortrabbit.
