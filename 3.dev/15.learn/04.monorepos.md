...
The builtin deployment tools are just one option to deploy code. It's also possible to connect fortrabbit to external CI/CD systems such as [GitHub Actions](/4.intergrations/03.git-providers/02.github.md#using-github-actions) by providing third party services direct SSH access through [deploy keys](/3.dev/15.learn/01.ssh-keys.md#deploy-keys).
