...
The fortrabbit [git deployment features](/1.platform/05.deployment/01.intro.md) are mainly designed for classical polyrepo (or multirepo) use cases, where each web project will have its own Git repo.
