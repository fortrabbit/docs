...
Like outlined with [project organization](/1.platform/02.setup/01.project-organization.md), some web projects may include a frontend and a backend stack in one repo.
