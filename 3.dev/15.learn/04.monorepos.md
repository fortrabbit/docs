...
Like outlined with [project organization](/1.platform/02.concepts/01.project-organization.md), some web projects may include a frontend and a backend stack in one repo.
...
The fortrabbit [git deployment features](/3.dev/03.deployment/01.intro.md) are mainly designed for classical polyrepo (or multirepo) use cases, where each web project will have it's own Git repo.
