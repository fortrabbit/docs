...
reviewer: fl
title: Monorepos
description: 'Deploy one project out of a monorepo on fortrabbit: source directory, build commands and the trade-offs of shared dependencies.'
...
head:
  meta:
    - name: 'keywords'
      content: 'mono-repo, mono repo, multisite, multi site, multi-site, poly repo, multi repo, github, turbo, composer, astro, fortrabbit'
topics:
  - deployment
  - git
---
...
The fortrabbit [git deployment features](/1.platform/06.deployment/01.intro.md) are mainly designed for classical polyrepo (or multirepo) use cases, where each web project will have its own Git repo.
