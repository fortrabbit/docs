...
description: 'A 301 is a permanent redirect, not an error. Where they come from on fortrabbit — forced HTTPS, domain routing and htaccess rules.'
naviTitle: 301 redirect
navigation.excerpt: Moved permanently
head:
  meta:
    - name: keywords
      content: '301 redirect, http status code, permanent redirect, htaccess, fortrabbit'
links:
