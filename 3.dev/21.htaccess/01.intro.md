...
description: 'The .htaccess file configures Apache one directory at a time. What it can do on fortrabbit, where it belongs, and what it cannot change.'
naviTitle: Intro
navigation.excerpt: What to do with .htaccess
figure:
  text: Apache web server configuration via .htaccess.
  color: rgb(59, 130, 246)
  textColor: rgb(219, 234, 254)
lead: The `.htaccess` file configures the Apache web server one directory at a time. On fortrabbit you can use it for redirects, access rules, compression and more — here is what it is and how to make use of it.
head:
  meta:
    - name: 'keywords'
      content: 'htaccess, Apache, web server configuration, hidden file'
topics:
  - htaccess
---
...
- GZIP compression is enabled by default for text based content types
