...
description: 'Put a username and password in front of an environment with HTTP basic auth in .htaccess — or use the dashboard setting instead.'
naviTitle: HTTP auth
...
The [fortrabbit dashboard also provides](/1.platform/07.settings/03.password-protection.md) a setting for this.
