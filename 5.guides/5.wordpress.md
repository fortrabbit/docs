...
naviTitle: WordPress
navigation.excerpt: The most PHPopular CMS
...
WordPress consists of code files, the user generated uploads and of course the [MySQL database](/9.components/2.database.md), in which most of the contents are stored. There are various use cases to export and import the database:
...
Sophisticated developers might have a look at rsync. It's many times faster than SFTP. See our [rsync article](/15.tips/rsync.md).
...
2. For the **files** you can either use [SFTP](/7.code-access/4.sftp.md) or have a look at [rsync](/15.tips/rsync.md) to synchronize certain folders.
