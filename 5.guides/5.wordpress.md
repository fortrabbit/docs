...
We assume you've already created an [app](/10.objects/1.app.md) and chose WordPress in the [software preset](/11.concepts/software-templates.md). If not: You can do so in the [fortrabbit dashboard](/11.concepts/dashboard.md).
