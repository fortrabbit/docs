...
We assume you've already created an [app](/10.objects/1.app.md) and chose WordPress in the [software preset](/12.platform/4.details/software-presets.md). If not: You can do so in the [fortrabbit dashboard](/11.concepts/dashboard.md).
...
Your environment URL `{{app-env-name}}.frb.io` is the first address your WordPress can be reached from. Later on, when you go live, you will add your own custom external domains. Here is the basic setup:
