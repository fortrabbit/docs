...
$ composer create-project getkirby/plainkit {{app-env-name}}
```
...
$ rsync -av ./content {{app-env-name}}@deploy.{{region}}.frbit.com:~
```
...
$ rsync -av {{app-env-name}}@deploy.{{region}}.frbit.com:~/content ./
```
