...
When the upload is finished, visit [{{app-env-name}}.frb.io](https://{{app-env-name}}.frb.io) in your browser and commence with the guided web installation to finish the setup.
