...
When the upload is finished, visit [{{app-env-slug}}.frbit.app](https://{{app-env-slug}}.frbit.app) in your browser and commence with the guided web installation to finish the setup.
