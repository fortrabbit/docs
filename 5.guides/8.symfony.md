...
:DashboardLink{title="Change the root path for {{app-env-name}}" path="apps/{{app-env-name}}/rootpath"}
...
:DashboardLink{title="Edit ENV vars for {{app-env-name}}" path="apps/{{app-env-name}}/env-vars"}
...
$ git remote add fortrabbit {{ssh-user}}@deploy.{{region}}.frbit.com:{{app-env-name}}.git
...
* [{{app-env-name}}.frb.io](https://{{app-env-name}}.frb.io)
