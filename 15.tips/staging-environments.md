...
Most likely you are developing with a [local PHP development environment](/15.tips/local-development.md) on your machine. So your laptop is already a of kind of **staging** while the actual part at fortrabbit is usually **production**.
