...
503 and [504 errors](/15.tips/http-errors/504.md) are two sides of the same coin. PHP-FPM (the PHP process manager here) has too much to do. 503 and 504 errors are often happening simultaneously.
...
Examine the logs of your environment. See [here](/11.concepts/logs.md). There you'll likely find where the application exited with which error. Compare this with your local development environment and see if it fails the same way. Review your latest code changes.
...
Review your code and configuration changes. Compare this with your [local development environment](/15.tips/1.local-development.md) and see if it fails the same way. Have you ran an update recently?
