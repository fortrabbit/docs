...
Then open a [terminal tunnel](#mysql-via-terminal), then visit your local phpMyAdmin in the browser. You now can select your fortrabbit App. You will be asked for the MySQL user "**{{app-env-slug}}**" and password. Using a local phpMyAdmin with your remote database requires you to always open a tunnel first - a [MySQL GUI](#mysql-via-gui) might be the better choice.
