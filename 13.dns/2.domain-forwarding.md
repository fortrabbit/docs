...
[Domains](/10.objects/10.domain.md) registered with the [dashboard](/11.concepts/dashboard.md) have a target setting. You can choose to route the domain directly to the root path of an environment or to be forwarded.
...
- Use `.htaccess` for more fine tuned control, see [htaccess redirects](/15.tips/htaccess/2.redirects.md)
