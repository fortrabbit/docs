...
It is recommended to forward all requests to the secure line, so no more "http://", only "http**s**://". You can do that with `.htaccess`, see [htaccess redirects](/15.tips/htaccess/2.redirects.md)
...
[Here](/15.tips/https-troubleshooting.md) are some things you can do on your own.
