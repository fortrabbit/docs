...
Most parts of the fortrabbit platform are very technical. Often the business owners are not developers. That's why there are two type of accounts with the fortrabbit dashboard:

- developer - technical person to manage technical aspects and billing
- client - non-technical person to only manage billing

You can choose your type of account when signing up and change it later on at any time if you made mistake initially. The dashboard access for clients is limited to billing and managing certain aspects of collaboration.

A client is powerful. They can change and delete the payment method, as well as individual apps. They can also disconnect and invite developers to take care of technical maintenance.
