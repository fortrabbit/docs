...
2. In the dashboard, find the :DashboardLink{title="invite to app" path="/invite/to-app"} link.
...
3. Accept the invite to gain a [developer connection](/15.collaboration/5.developer-connection.md)

### Consequences

- Invited developers have a [developer connection](/15.collaboration/5.developer-connection.md)
