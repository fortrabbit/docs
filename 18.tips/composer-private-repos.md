...
Modern PHP app development utilizes [Composer](/18.tips/composer.md) as a dependency manager. There are many great open source packages [out there](http://packagist.org). But your company code is probably not intended to be released to the public or you rely on a third party package which is not open source. That's when you use private Composer repositories.
...
Since you don't want to keep secrets in your git history, you can store them in [ENV vars](/14.concepts/env-vars.md).
