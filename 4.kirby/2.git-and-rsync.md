...
See the [git guides](/6.deployment/1.intro.md) on how to connect a local repo to the GitHub remote and enable automatic deployment by installing the fortrabbit App with GitHub account.
