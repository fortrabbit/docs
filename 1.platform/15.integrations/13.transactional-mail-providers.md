...
This is not working any more these days, since such mails are sent anonymously — not from a real mail server. Your email not reach the inbox of your clients. Sendmail is disabled with our hosting service here for this reason, see [quirks](/1.platform/03.concepts/04.limits.md#mailing).
...
- [SendGrid](https://sendgrid.com) - see also [the article](/1.platform/15.integrations/sendgrid.md)
