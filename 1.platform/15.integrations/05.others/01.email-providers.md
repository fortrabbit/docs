...
2. Emails sent from your application, see [transaction mails](/1.platform/15.integrations/02.transactional-mail/01.intro.md)
...
- Classical web-hosting packages often include domain registration and e-mail services. Some [domain providers](/1.platform/15.integrations/01.dns/01.intro.md) also offer email accounts.
