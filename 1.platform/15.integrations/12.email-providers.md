...
figure:
  emoji: ✉️
  text: Professional email solutions.
...
2. Emails sent from your application, see [transaction mails](/1.platform/15.integrations/13.transactional-mail-providers.md)
...
- Classical web-hosting packages often include domain registration and e-mail services. Some [domain providers](/1.platform/15.integrations/10.domain-providers.md) also offer email accounts.
