...
A better solution might be to use a "transactional mail service", those are built to do the bulk mailing — see [transactional mail](/1.platform/15.integrations/13.transactional-mail-providers.md).
