...
**Recommended**: to use a "transactional mail service", those are built to ensure email delivery and will notify you when delivery fails — see [transactional mail](/1.platform/15.integrations/13.transactional-mail-providers.md) for more details. These providers are easily integrated via an API and there are plugins for CMS and frameworks.
