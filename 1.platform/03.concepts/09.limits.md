...
The SSH environment is "jailed". So you can use it for [deployment and common development tasks](/1.platform/04.code-access/03.ssh.md), but it's NOT possible to install software like: FFmpeg, Node, NPM, Gulp, webpack, ruby, Rails or a mail server. We do this for security and performance reasons.
