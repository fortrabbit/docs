...
description: 'Prefer one fortrabbit account per person. When a second account makes sense, and how people, teams, apps and payment methods relate.'
navigation.excerpt: How to organize fortrabbit accounts.
figure:
  emoji: 👤 👤 👤
  text: One or many?
  color: rgb(14, 110, 160)
  textColor: rgb(186, 200, 210)
...
head:
  meta:
    - name: keywords
      content: 'account organization, fortrabbit account, multiple accounts, account separation, github identity, team collaboration'
links:
