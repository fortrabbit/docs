...
Only people act; everything else is an object. One account lets you manage multiple [apps](/1.platform/10.objects/01.app.md), [teams](/1.platform/10.objects/04.team.md), and [payment methods](/1.platform/10.objects/09.payment-method.md).
