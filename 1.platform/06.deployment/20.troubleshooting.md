...
description: 'Git deployment failing on fortrabbit? Check the GitHub App connection, the branch, the build commands and the deploy log, in that order.'
...
- Read the [deployment intro](/1.platform/06.deployment/01.intro.md)
- Have the [fortrabbit GitHub app](/1.platform/06.deployment/02.github-app.md) installed with GitHub
...
- Make sure to have the [fortrabbit GitHub App](/1.platform/06.deployment/02.github-app.md) installed and connected
...
- Check the [deploy logs](/1.platform/06.deployment/17.logs.md) to see the error
