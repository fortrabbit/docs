...
The CLI is a single binary named `frbit`. It is a client of the [public API](/1.platform/04.automation/01.api.md) and it authenticates with your personal API token.
