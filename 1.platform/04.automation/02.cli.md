...
The CLI is a client of the [public API](/1.platform/04.automation/01.api.md) — everything it does is an API call, and it authenticates with the same personal API token.
...
Reach for the CLI when a person or a script drives the work. AI agents love it too, they can use it as an alternative to or in conjunction with the [MCP server](/1.platform/04.automation/03.mcp.md).
