...
reviewed: 2026-08-24
title: Public API
description: 'The fortrabbit public API is a REST interface for apps, environments, deployments and domains, authenticated with a personal token.'
naviTitle: API
...
lead: The fortrabbit public API is a REST interface to manage apps, environments, deployments and domains. It authenticates with a personal API token and is the foundation for the CLI.
links:
...
- A capability is missing from the [CLI](/1.platform/04.automation/03.cli.md) and the [MCP server](/1.platform/04.automation/02.mcp.md)
