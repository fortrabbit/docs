...
When working with the AI agents with fortrabbit, these skills are not required but recommended. You can also just use a basic agent via [CLI](/1.platform/04.automation/02.cli.md) or [MCP](/1.platform/04.automation/03.mcp.md) the skills.

The package ships two skills:

- `fortrabbit` - Deployment, SSH, database sync discovery, provisioning
- `fortrabbit-api-access` - Connect to [MCP](/1.platform/04.automation/03.mcp.md) or [API](/1.platform/04.automation/01.api.md)
