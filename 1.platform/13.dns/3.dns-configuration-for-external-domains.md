...
Your domain provider, sometimes called domain registrar, is the service where you purchased the domain. Common names are as GoDaddy, Enom, or Name.com. See [general domain provider integration](/1.platform/15.integrations/01.dns/01.intro.md) as well.
...
Also See [integration instructions](/1.platform/15.integrations/01.dns/02.cloudflare.md).
