...
Your domain provider, sometimes called domain registrar, is the service where you purchased the domain. Common names are as GoDaddy, Enom, or Name.com. See [general domain provider integration](/1.platform//14.integrations/10.domain-providers.md) as well.
...
Also See [integration instructions](/1.platform/14.integrations/02.cloudflare.md).
