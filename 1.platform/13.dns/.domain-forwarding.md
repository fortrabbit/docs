...
description: 'Point a second domain at an environment: forward it with a 301 to the primary domain, or route it to the environment directly.'
...
figure:
  emoji: '🔀'
  text: 'One name points to another.'
  color: rgb(130, 120, 150)
  textColor: rgb(26, 22, 36)
head:
  meta:
    - name: 'keywords'
