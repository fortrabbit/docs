...
title: Apex domains
description: 'Apex domains carry no prefix and cannot be routed directly on fortrabbit. Use a www domain and the forwarding service instead.'
...
Direct routing of apex domains to environments is not supported at fortrabbit. You can use a www domain; the [www forwarding service](/1.platform/13.dns/04.domain-forwarding-service.md) will redirect all requests.
