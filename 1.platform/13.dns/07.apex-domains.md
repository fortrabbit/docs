...
Direct routing of apex domains to environments is not supported at fortrabbit. You can ese a www domain, the [www forwarding service](/1.platform/13.dns/04.domain-forwarding-service.md) will redirect all requests.
