...
It is recommended to forward all requests to the secure line, so no more "http://", only "http**s**://". You can do that with `.htaccess`, see [htaccess redirects](/3.dev/21.htaccess/2.redirects.md).
