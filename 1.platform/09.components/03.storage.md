...
- `df` reports actual disk free space and is more accure for how files are stored on disk. On fortrabbit run `df -h .` to see the real disk usage, or you can just look at the dashboard metrics to see the same value.
