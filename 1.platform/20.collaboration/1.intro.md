...
Sign up to fortrabbit as an individual, not a company. In fact the account is part of the [person object](/1.platform/10.objects/3.person.md). Mind that your personal [public SSH keys](/3.dev/15.learn/01.ssh-keys.md) are also stored with your account.
