...
figure:
  ...
  color: rgba(200, 115, 22, 1)
  textColor: rgba(220, 170, 116, 1)
...
See [account organization](/1.platform/03.concepts/04.account-organization.md) for more details when or when not to use multiple accounts at fortrabbit.
