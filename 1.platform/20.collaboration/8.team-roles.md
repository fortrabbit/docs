...
- subscribe and unsubscribe from apps - see [developer connection](/1.platform/16.collaboration/5.developer-connection.md#app-subscription-through-teams)
...
- request access on team apps - see [developer connection](/1.platform/16.collaboration/5.developer-connection.md#app-subscription-through-teams)
