...
figure:
  emoji: 🎭
  text: Who are you?
  color: rgba(200, 63, 94, 1)
  textColor: rgba(220, 164, 175, 1)
# lead: Your account type defines how
---

## Understand individual access

An account on fortrabbit represents a person, not an entity. Your account settings are part of your [personal access](/1.platform/10.objects/03.person.md) to the fortrabbit system, also see [account organization](/1.platform/03.concepts/04.account-organization.md). You can choose your type of account when signing up and change it later on if you made mistake initially.
