...
3. Accept the invite to gain a [developer connection](/1.platform/20.collaboration/5.developer-connection.md)

### Consequences

- Invited developers have a [developer connection](/1.platform/20.collaboration/5.developer-connection.md)
