...
```bash
# Trigger
curl -X POST https://api.fortrabbit.com/v1/webhooks/environments/{{ app-env-id }}/deploy/{{ LONGSTRING }}

# Get
curl https://api.fortrabbit.com/v1/webhooks/environments/{{ app-env-id }}/deploy/{{ LONGSTRING }}
```
