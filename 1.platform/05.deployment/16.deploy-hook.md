...
```bash
# Trigger
curl -X POST https://api.fortrabbit.com/v1/deploy/{{app-env-id}}/deploy-hook/LONGSTRING

# Get
curl https://api.fortrabbit.com/v1/deploy/{{app-env-id}}/deploy-hook/LONGSTRING
```
