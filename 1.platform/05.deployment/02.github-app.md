...
lead: Connect the most popular Git-as-a-service provider with your fortrabbit. Login with GitHub and use automatic git push to deploy.
links:
...
- You also have a good understanding of the fortrabbit [deployment options](/1.platform/05.deployment/01.intro.md).
