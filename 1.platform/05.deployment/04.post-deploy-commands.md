...
You have followed the [deployment section](/1.platform/05.deployment/index.md) and are ready to deploy code via git using the [GitHub integration](/1.platform/05.deployment/02.github-app.md).

## Architecture

Post deploy commands are similar to [build commands](/1.platform/05.deployment/03.build-commands.md), but they run after the build files have been copied into the live environment. Both build commands and post deploy commands are run in a separate deployment container.
