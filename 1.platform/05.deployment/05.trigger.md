...
When manual deployment is selected, no automatic deployments will happen. Initiate a deployment from the [dashboard](/1.platform/02.concepts/30.dashboard.md).
