...
description: 'Set environment variables for a fortrabbit environment in the dashboard, in dotenv format, with Base64 for values holding special characters.'
naviTitle: ENV vars
...
lead: Set and manage environment variables on fortrabbit via the dashboard; supports dotenv format with Base64 encoding for special characters.
head:
  meta:
    - name: keywords
      content: 'environment variables, ENV vars, configuration, dotenv, fortrabbit'
links:
