...
description: 'Put HTTP basic authentication in front of an entire environment from the dashboard — the usual guard for staging and development URLs.'
...
Username/password can also be [configured through .htaccess](/3.dev/21.htaccess/03.http-auth.md) instead of the dashboard setting. Some software systems also offer settings or plugins for that.
