...
figure:
  emoji: 💬
  text: Stuck somewhere? We aim to help.
  color: rgb(227, 185, 208)
  textColor: rgb(109, 76, 94)
siblings: Support
links:
  - title: Support policies
    route: /legal/support-policy
    property: www
  - title: Benefit dev support
    route: /benefits/developer-support
    property: www
---
