...
Most parts of the fortrabbit platform are very technical. Often the business owners are not developers. That's why there are two type of accounts with the fortrabbit dashboard: developer and clients. See [account types](/1.platform/16.collaboration/6.account-types.md) for more.
