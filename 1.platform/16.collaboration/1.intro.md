...
Sign up to fortrabbit as an individual, not a company. In fact the account is part of the [person object](/1.platform/10.objects/3.person.md). Mind that your personal [public SSH keys](/3.dev/ssh-keys.md) are also stored with your account.
...
Every interaction with the fortrabbit services will be recorded and associated with you. In the dashboard those actions are shown as [events](/1.platform/10.objects/events.md) and are important part of collaboration and help with accountability. -->
