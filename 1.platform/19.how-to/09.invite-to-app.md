...
links:
  - title: Team invite
    route: /platform/collaboration/team-invite
...
1. You need to have an [app](/1.platform/10.objects/1.app.md) already
...
3. Accept the invite to gain a [developer connection](/1.platform/16.collaboration/5.developer-connection.md)

### Consequences

- Invited developers have a [developer connection](/1.platform/16.collaboration/5.developer-connection.md)
...
If you plan to collaborate with someone on a regular basis and on more than one app, consider using a [team](/1.platform/10.objects/4.team.md).
