...
[Payment methods](/1.platform/10.objects/09.payment-method.md) can be attached to teams. Teams can own apps via payment methods created by their members. This also allows billing collaboration, when teams participate on payment methods by clients.
