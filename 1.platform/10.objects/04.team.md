...
You can invite more team member through the dashboard. More details [here](/1.platform/16.collaboration/10.team-invite.md).

## Access levels

There are two roles with the team: limited and unlimited. See the [team roles article](/1.platform/16.collaboration/7.team-roles.md) for more.
