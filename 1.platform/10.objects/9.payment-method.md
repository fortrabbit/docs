...
- Each app - except [during trial](/1.platform/11.concepts/2.free-trial.md) - is owned by a payment method
- Payment methods can own multiple [apps](/1.platform/10.objects/1.app.md)
- Payment methods are managed by people directly or in [teams](/1.platform/10.objects/4.team.md)
...
- People are connected to payment methods by a [billing connection](/1.platform/16.collaboration/5.billing-connection.md)
...
You may be collaborating with other, in a team or in a client relation. Payment methods can also be shared. You can [invite someone to collaborate or to take over a payment method](/3.dev/inviting-a-client.md).
...
Deleting a payment method is similar to a [service cancellation](/3.dev/service-cancellation.md), since all the apps owned will be deleted as well and the invoice archive will be removed.
