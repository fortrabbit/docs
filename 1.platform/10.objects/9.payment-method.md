...
You may be collaborating with other, in a team or in a client relation. Payment methods can also be shared. You can [invite someone to collaborate or to take over a payment method](/15.tips/inviting-a-client.md).
...
Deleting a payment method is similar to a [service cancellation](/15.tips/service-cancellation.md), since all the apps owned will be deleted as well and the invoice archive will be removed.
