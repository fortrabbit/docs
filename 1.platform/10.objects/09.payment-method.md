...
You may be collaborating with other, in a team or in a client relation. Payment methods can also be shared. You can [invite someone to collaborate or to take over a payment method](/1.platform/20.collaboration/19.how-to/.20.invite-a-client.md).
