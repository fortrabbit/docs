...
While the Git repo is connected with the [app](/1.platform/10.objects/01.app.md), the environment can be mapped to a git branch. [Git deployment](/1.platform/05.deployment/01.intro.md) is optional but blends in nicely.
