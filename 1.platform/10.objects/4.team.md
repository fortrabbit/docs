...
You can create as many teams as you want with the dashboard. Teams are free of charge. Here is the link to get started: :DashboardLink{title="Create a team" path="/new/team"}
