...
reviewed: 2026-01-29
title: Event filters
description: 'Events in the fortrabbit dashboard form an audit log of every action on an app. Filters narrow that stream down to what matters.'
navigation.excerpt: Audit log and notification system
figure:
  emoji: 🗃️
  text: Create custom audit filters.
  color: rgb(6, 182, 212)
