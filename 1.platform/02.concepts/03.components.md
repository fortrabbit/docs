...
See the [components list](/1.platform/09.components/) for all available components. The [pricing page](https://www.fortrabbit.com/pricing) gives you an overview. The [pricing intro](/1.platform/12.billing/01.pricing-structure.md) explains level billing concepts.
...
All components are available with the [free trial](/1.platform/02.concepts/02.free-trial.md). They are however limited to the smallest plan.
