...
See the [components list](/1.platform/9.components/) for all available components. The [pricing page](https://www.fortrabbit.com/pricing) gives you an overview. The [pricing intro](/1.platform/12.billing/01.pricing-structure.md) explains level billing concepts.
