...
When you login with [SFTP](/3.dev/01.code-access/4.sftp.md) or [SSH](/3.dev/01.code-access/3.ssh.md) to your [app environment](/1.platform/10.objects/02.app-environment.md) you can see the file directory structure. This is what you'll find:
