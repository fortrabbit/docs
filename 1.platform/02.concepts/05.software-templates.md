...
The software template saves some work and helps to prevent errors. It's non-destructive, change all settings later on. This is especially handy with modern software that supports [ENV var](/3.dev/19.env-vars/1.intro.md/2.usage.md) configuration and environment detection — like Laravel or Craft CMS do. It makes the application really portable, you can deploy the same code base to anywhere else and it will work out of the box.
