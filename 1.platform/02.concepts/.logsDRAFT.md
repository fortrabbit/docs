...
All logs are available through the [fortrabbit dashboard](/1.platform/02.concepts/30.dashboard.md), individual per [environment](/1.platform/10.objects/environment/01.intro.md). A live log stream as well as historical logs are available for `stdout` and `stderr`.
