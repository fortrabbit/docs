...
- If the currently booked [backup plan](/1.platform/9.components/5.backups.md) includes one daily backup, the new manual backup will replace the current backup.
