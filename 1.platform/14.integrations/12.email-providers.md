...
2. Emails sent from your application, see [transaction mails](/14.integrations/3.transactional-mail-providers.md)
...
- Classical web-hosting packages often include domain registration and e-mail services. Some [domain providers](/14.integrations/1.domain-providers.md) also offer email accounts.
