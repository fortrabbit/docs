...
On fortrabbit you can set the root path for each environment with the routing settings in the dashboard. When choosing a [software template](/1.platform/02.concepts/05.software-templates.md) the correct root path will pre-configured.
