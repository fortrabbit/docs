...
fortrabbit only supports the InnoDB storage engine. If your source database uses MyISAM or another engine, convert all affected tables **before** importing — otherwise the import will fail.
