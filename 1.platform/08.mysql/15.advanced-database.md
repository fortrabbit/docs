...
We don't support other storage engines than InnoDB. Tables should be converted on source before dumping.

1. via ALTER TABLE x ENGINE=InnoDB
2. edit SQL dump and replace occurrences of`CREATE TABLE ... ENGINE=MyISAM` with `ENGINE=InnoDB`)
