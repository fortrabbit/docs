...
The following commands are run on your local computer. The `mysql` command line client is required. Exact commands may differ depending on the kind of [local development environment](/3.dev/20.how-to/1.local-development.md).
