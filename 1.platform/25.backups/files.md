...
The database backup file is a standard dump created by the `mysqldump` tool. Restore it by importing the data into your MySQL database. For detailed instructions, refer to our [database export/import guides](/3.dev/08.mysql/02.export-import/07.export-import-intro.md). It may be necessary to drop the old tables before importing the new data.
