...
description: 'The directory layout of a fortrabbit environment — the web root under htdocs, the home directory and the writable data folders.'
lead: Learn the file structure of your fortrabbit app. Understand how the web root (htdocs), home, and data directories are organized when you connect via SSH or SFTP.
...
head:
  meta:
    - name: 'keywords'
      content: 'directory structure, directories, web root, document root, htdocs, home directory, fortrabbit'
topics:
  - ssh
  - sftp
  - storage
...
When you log in with [SFTP](/1.platform/05.code-access/04.sftp.md) or [SSH](/1.platform/05.code-access/03.ssh.md) to your [environment](/1.platform/10.objects/02.environment.md), you can see the directory structure. This is what you'll find:
