...
With a postpaid model, also called in arrears, on the other side. Customers make use of the service and pay later after usage for the [monthly service period](5.schedule.md).
...
Postpaid enables [prorated billing with daily usage aggregation](03.daily-aggregation.md). This again makes it easy to experiment with the hosting service as you'd aspect for agile workflows.
