...
reviewer: fl
title: Late payments
description: 'When a payment bounces on fortrabbit: why it happens, what the platform retries automatically, and how to settle an open invoice.'
...
head:
  meta:
    - name: keywords
      content: 'late payments, bounced payments, payment failures, failed charges, app deletion, invoice, fortrabbit'
topics:
  - billing
---
...
Payments bounce for several common reasons:
...
Please contact us if you are aware about open invoices with us and or if you have questions about an invoice. In any case, we will inform you by e-mail about failed payments.

## Automatic retries

Over the course of the month we will retry previously failed payments. This helps resolve about half of initial bounces.
...
Apps are deleted based on account age and payment history. The policy is tiered as follows:
