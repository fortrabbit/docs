...
description: 'Move an app from the old fortrabbit platform to the new one at an own pace, with a git-based workflow, hands-on support and a discount.'
naviTitle: Self migration
navigation.excerpt: Old → new - in your own pace
figure:
  emoji: 🚦
  text: Move your app to the new platform.
