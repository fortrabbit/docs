...
If you like to use git push to deploy your app, you can do so with the new platform. For now, only GitHub is supported. See [GitHub integration](/1.platform/05.deployment/02.github-app.md) for more details.
