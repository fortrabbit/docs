---
reviewed: 2026-05-26 16:30:42
title: New fortrabbit platform BETA
description: 'The new fortrabbit platform is in public beta: live, stable and open for production, with regular releases and direct support.'
naviTitle: BETA (now)
navigation.excerpt: Hardening and tuning
lead: The new fortrabbit platform is in public BETA — live, stable, and open for production use. New features land regularly, pricing is attractive, and direct support is available throughout the BETA period.
head:
  meta:
    - name: keywords
      content: 'fortrabbit BETA, new platform, PHP hosting BETA, public beta'
links:
...
| [Migration start](/1.platform/01.new/9.migration.md) |    ~EO 2026 |
...
- Streaming logs implementation will change, [see log usage](/1.platform/07.settings/25.logs.md)
...
The [legal section](https://www.fortrabbit.com/legal) has been updated. The [new terms](https://www.fortrabbit.com/legal/contract/terms) are applicable for new and old customers for the new and the old platform. There are only minor adjustments.
...
## Discount for feedback

We are happy to provide individual discount during BETA in exchange for feedback, when discovering issues, or just discussing your requirements and desired features.
