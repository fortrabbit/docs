...
description: 'fortrabbit runs two platforms in parallel. The old and the new one side by side — dashboard, stacks, storage, scaling and pricing.'
...
links:
  - title: Specs Uni Stack
    route: /old-platform/specs-uni
    property: www
  - title: Specs Pro Stack
    route: /old-platform/specs-pro
    property: www
nextNav: true
topics:
  - migration
...
- **2026** [Migration](/1.platform/01.new/9.migration.md) phase old → new
