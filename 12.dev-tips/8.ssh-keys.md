...
To import the public part into your fortrabbit Account via Dashboard, read about [importing keys](8.ssh-keys.md#import-a-public-keys-into-your-fortrabbit-account) further down.
