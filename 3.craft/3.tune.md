...
For general information on how to add domains to your fortrabbit App, please see our [domains article](/8.dns/1.setup.md). For Craft CMS be sure to have set your domain's root path to the `/web` folder.
